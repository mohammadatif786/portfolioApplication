...
@section('content')
    <div class="st-content">
        <div class="st-page-heading st-dynamic-bg" data-src="frontened/img/hero-bg17.jpg">
            <div class="container">
                <div class="st-page-heading-in text-center">
                    <h1 class="st-page-heading-title">Dynamically procrastinate B2C users <br>after installed base
                        benefits..</h1>
            ...
            <div class="row">
                <div class="col-lg-10 offset-md-1">
                    <div class="st-post-details st-style1">
                        ...
                        <img class="st-zoom-in" src="frontened/img/hero-bg3.jpg" alt="blog1">
                            ...
                            <div class="st-post-text">
                                ...
                                <div class="embed-responsive embed-responsive-16by9">
                                    <iframe class="embed-responsive-item" width="816" height="459"
                                        src="https://www.youtube.com/embed/vGOL7ZvuGMc" allowfullscreen>
                                    </iframe>
                                </div>
                                ...
                                <blockquote>Integer accumsan arcu ligula, eget dictum augue egestas sed. Curabitur
                                    bibendum, lorem ac dapibus pellentesque, justo lectus bibendum enim.<small>by:
                                        <span>Mark Parker</span></small></blockquote>
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    suffered alteration some form, by injected humour, or randomised words which don't
                                    look even slightly believable. If you are going to use passage of Lorem Ipsum.</p>
                                    ...
                                    <div class="slick-container" data-autoplay="0" data-loop="1" data-speed="800"
                                        ...
                                        <div class="slick-wrapper">
                                            <div class="slick-slide-in">
                                                <img class="st-zoom-in" src="frontened/img/hero-bg4.jpg" alt="blog1">
                                            </div>
                                            <div class="slick-slide-in">
                                                <img class="st-zoom-in" src="frontened/img/hero-bg3.jpg" alt="blog1">
                                            </div>
                                            <div class="slick-slide-in">
                                                <img class="st-zoom-in" src="frontened/img/hero-bg5.jpg" alt="blog1">
                                            </div>
                                        </div>
                                    </div><!-- .slick-container -->
                    ...
                    <div class="comments-area">
                                    ...
                                    <div class="comment-body">
                                        <div class="comment-meta">
                                            <div class="comment-author">
                                                <img src="frontened/img/comment1.jpg" alt="comment1" class="avatar">
                                    ...
                                    <ol class="children">
                                        <li class="comment">
                                            <div class="comment-body">
                                                <div class="comment-meta">
                                                    <div class="comment-author">
                                                        <img src="frontened/img/comment2.jpg" alt="comment1" class="avatar">
                        ...
                        <div class="comment-respond">
                            ...
                            <form method="post" class="comment-form">
                                ...
                                <p class="form-submit">
                                    <button type="submit" class="st-btn st-style1 st-color1 st-size-medium">Post
                                        Comment</button>
                                </p>
                            </form>
                        </div><!-- .comment-respond -->
