        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="{{ asset('frontened/img/portfolio/portfolio1_lg.jpg')}}"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="{{ asset('frontened/img/portfolio/portfolio1.jpg')}}" alt="portfolio">
                                </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="{{ asset('frontened/img/portfolio/portfolio2_lg.jpg')}}"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="{{asset('frontened/img/portfolio/portfolio2.jpg')}}" alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                                    <h5>Product Design</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="{{ asset('frontened/img/portfolio/portfolio3_lg.jpg')}}"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="{{ asset('frontened/img/portfolio/portfolio3.jpg')}}" alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                                    <h5>Product Design</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="{{ asset('frontened/img/portfolio/portfolio4_lg.jpg')}}"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="{{ asset('frontened/img/portfolio/portfolio4.jpg')}}" alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                                    <h5>Product Design</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="{{asset('frontened/img/portfolio/portfolio5_lg.jpg')}}"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="{{asset('frontened/img/portfolio/portfolio5.jpg')}}" alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                                    <h5>Product Design</h5>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="st-portfolio-single st-style1 st-lightgallery">
                        <div class="st-portfolio-item">
                            <a href="{{asset('frontened/img/portfolio/portfolio6_lg.jpg')}}"
                                class="st-portfolio st-zoom st-lightbox-item">
                                <div class="st-portfolio-img st-zoom-in">
                                    <img src="{{asset('frontened/img/portfolio/portfolio6.jpg')}}" alt="portfolio">
                                </div>
                                <div class="st-portfolio-item-hover">
                                    <i class="fas fa-plus-circle"></i>
                                    <h5>Product Design</h5>
                    ...
                    <div class="slick-wrapper">
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                ...
                                <div class="st-testimonial-text">
                                    ...
                                    <div class="st-quote"><img src="{{asset('frontened/img/icon/quote.png')}}" alt="quote"></div>
                                </div>
                                <div class="st-testimonial-info">
                                    <div class="st-testimonial-img"><img src="{{asset('frontened/img/client/client1.png')}}"
                                            alt="client1"></div>
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                ...
                                <div class="st-testimonial-info">
                                    <div class="st-testimonial-img"><img src="{{asset('frontened/img/client/client2.png')}}"
                                            alt="client2"></div>
                                    <div class="st-testimonial-meta">
                        ...
                        <div class="slick-slide-in">
                            <div class="st-testimonial st-style1 wow fadeInLeft" data-wow-duration="0.8s"
                                ...
                                <div class="st-testimonial-info">
                                    <div class="st-testimonial-img"><img src="{{asset('frontened/img/client/client3.png')}}"
                                            alt="client3"></div>
                                    <div class="st-testimonial-meta">
